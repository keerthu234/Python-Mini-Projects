...
def update_contact():
    keyword = input("Enter the name of the contact to update: ").strip().lower()
    for contact in contacts:
        if contact["name"].lower() == keyword:
...
def delete_contact():
    keyword = input("Enter the name of the contact to delete: ").strip().lower()
